<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OrdersAccepted.aspx.cs" Inherits="OrdersAccepted" %>
...
<div class="main">
    ...
    <h1 id="h1_Title">Przyjęte kursy</h1>

        <br />

        <asp:Panel ID="p_Orders" runat="server">
            <asp:GridView ID="gv_Orders" runat="server" AutoGenerateColumns="False" 
                CellPadding="4" DataSourceID="ds_Orders" ForeColor="#333333" CssClass="Orders"
    ...
    <SortedDescendingHeaderStyle BackColor="#6F8DAE"></SortedDescendingHeaderStyle>
            ...
            <asp:ObjectDataSource ID="ds_Orders" runat="server" 
                SelectMethod="getAcceptedOrdersView" TypeName="BLL.Repository">
