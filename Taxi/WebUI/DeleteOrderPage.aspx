<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DeleteOrderPage.aspx.cs" Inherits="DeleteOrderPage" %>
...
<div class="main">
    ...
    <h1 id="h1_Title">Potwierdzenie usunięcia</h1>
        ...
        <h2>Czy na pewno usunąć poniższy kurs ?</h2>
            <p>
