<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OrdersCanceled.aspx.cs" Inherits="OrdersCanceled" %>
...
<div class="main">
    ...
    <h1 id="h1_Title">Anulowane kursy</h1>
    ...
    <SortedDescendingHeaderStyle BackColor="#6F8DAE"></SortedDescendingHeaderStyle>
            ...
            <asp:ObjectDataSource ID="ds_Orders" runat="server" 
                SelectMethod="getCanceledOrdersView" TypeName="BLL.Repository">
