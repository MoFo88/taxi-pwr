<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OrdersInProgres.aspx.cs" Inherits="OrdersInProgres" %>
...
<div class="main">
    ...
    <h1 id="h1_Title">Wykonywane kursy</h1>
    ...
    <SortedDescendingHeaderStyle BackColor="#6F8DAE"></SortedDescendingHeaderStyle>
            ...
            <asp:ObjectDataSource ID="ds_Orders" runat="server" 
                SelectMethod="getInProgressOrdersView" TypeName="BLL.Repository">
